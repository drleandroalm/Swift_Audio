...
final class ANEMemoryOptimizer {
    ...
    static let aneAlignment = ANEMemoryUtils.aneAlignment
    static let aneTileSize = ANEMemoryUtils.aneTileSize
...
@available(macOS 13.0, iOS 16.0, *)
class ZeroCopyDiarizerFeatureProvider: NSObject, MLFeatureProvider {
